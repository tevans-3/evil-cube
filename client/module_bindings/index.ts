...
const reducersSchema = __reducers(
  ...
  __reducerSchema("set_distance_to_solve", SetDistanceToSolveReducer),
  __reducerSchema("set_human_status", SetHumanStatusReducer),
  __reducerSchema("set_name", SetNameReducer),
  __reducerSchema("set_verified", SetVerifiedReducer),
  __reducerSchema("test_and_set_best_score", TestAndSetBestScoreReducer),
);
